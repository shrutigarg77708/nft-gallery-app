## Project Setup: Start Hardhat Project
...
## Project Setup: Write NFT Contract Code
...
## Project Setup: Compile the contract
...
## Project Setup: Configuring Deployment
...
## Project Setup: Verify on Etherscan
...
## Project Setup: Play with your new NFT contract

   - Mint token
   - Transfer Token


## Project Setup: View your NFT on OpenSea (API Key Needed)
